...
用法
----
$ python scripts/weekday_stats.py                        # 上证指数（默认）
$ python scripts/weekday_stats.py --index sh000300       # 沪深300
$ python scripts/weekday_stats.py --index sz399001       # 深证成指
$ python scripts/weekday_stats.py --start 2015           # 指定起始年
...
脚本: scripts/weekday_stats.py · 数据: 本地指数缓存（akshare 腾讯源）</div>
</body></html>"""
