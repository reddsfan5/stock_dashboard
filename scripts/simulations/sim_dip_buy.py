...
用法：
  python -m scripts.simulations.sim_dip_buy
  python -m scripts.simulations.sim_dip_buy --capital 500000 --target 2.0 --overlap 4.0
  python -m scripts.simulations.sim_dip_buy --capital 100000 --target 1.5 --commission 1.0
"""
...
示例:
  python -m scripts.simulations.sim_dip_buy
  python -m scripts.simulations.sim_dip_buy --capital 100000 --target 2.0
  python -m scripts.simulations.sim_dip_buy --board all                # 全A股
  python -m scripts.simulations.sim_dip_buy --board main               # 仅沪深主板（默认）
  python -m scripts.simulations.sim_dip_buy --capital 500000 -m 1.5 --overlap 4.0 --lookback 10
        """,
    )
