...
用法:
  python -m scripts.simulations.sim_etf_momentum                        # 默认 30天×5只
  python -m scripts.simulations.sim_etf_momentum --hold 10 --top 3      # 10天×3只
  python -m scripts.simulations.sim_etf_momentum --start 2024-01-01     # 指定起始
"""
