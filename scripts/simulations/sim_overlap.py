...
用法：
  python -m scripts.simulations.sim_overlap                           # 比亚迪，5万起
  python -m scripts.simulations.sim_overlap --code sh600519             # 茅台
  python -m scripts.simulations.sim_overlap --days 5 --pct 3.0          # 更严格的条件
  python -m scripts.simulations.sim_overlap --capital 100000 --target 2.0
"""
