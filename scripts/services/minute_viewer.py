...
#chartWrap{{position:relative;width:100%}}#chart{{height:650px;width:100%;touch-action:pan-y;overscroll-behavior:contain}}#chart.is-scrubbing{{touch-action:none}}
