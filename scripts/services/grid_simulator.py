...
<style>
:root{--bg:#f3f5f8;--panel:#fff;--text:#20242c;--muted:#737b8c;--border:#e2e6ed;--blue:#3478f6;--red:#e5484d;--green:#16a36a;--orange:#dd8b00;--purple:#7656d6;--value-bg:#f6f8fb}
...
<main class="page">
  ...
  <section class="panel controls">
    <div class="primary">
      <div class="field search"><label>标的代码或名称</label><input id="code" value="518880" autocomplete="off" placeholder="例如 518880"><div class="results" id="results"></div></div>
