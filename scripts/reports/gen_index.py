...
GROUPS = [
    ...
    },
    {
        ...
        "tone": "research",
        "items": [
            ("market_gap_backtest.html", "↕️", "指数高低开三日回测", "按指数、日期、缺口百分比和退出日动态统计高低开后的路径、胜率、强度分层与年度稳定性", "择时研究"),
            ("holiday_effect.html", "🏮", "节假日效应回测", "元旦/春节/五一/中秋/国庆休市前后多标的（沪深300/上证指数）表现、标的对比、小盘成长相对强弱与当年节前位置", "择时研究"),
            ("sector_corr_cloud.html", "🌌", "板块相关点云", "同步相关 + 领先传导箭头（周频滞后/跟涨跟跌概率），查询自动扩展", "板块跟踪"),
            ("sector_atlas.html", "◈", "板块图谱", "五层阅读（国家/社会/个人/股市/产业）理解板块：锂电、银行、白酒、电力、通信等二十余个专题", "产业认知"),
