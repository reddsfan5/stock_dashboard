...
<div class="chapter-body"><figure><button class="atlas-image" data-image="{e(src)}" data-caption="{e(chapter['title'])}" aria-label="放大：{e(chapter['title'])}"><img src="{e(src)}" alt="{e(chapter['alt'])}" loading="lazy" width="{width}" height="{height}"></button><figcaption>用户提供原图 · 点击放大，可切换原始尺寸</figcaption></figure>
