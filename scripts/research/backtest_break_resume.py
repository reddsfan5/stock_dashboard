...
用法
----
$ python -m scripts.research.backtest_break_resume                        # K=5, m=1.5%, 5000万
$ python -m scripts.research.backtest_break_resume --streak 10 --gap 2
$ python -m scripts.research.backtest_break_resume --streaks 2,3,5,8,10   # 多档连续天数对比
$ python -m scripts.research.backtest_break_resume --start 2010-01-01     # 全历史
...
<div class="footer">生成: scripts/research/backtest_break_resume.py · 事件明细: output/break_resume_events.csv · 图上灰pin=中断日，绿pin=次日恢复，红pin=次日未恢复</div>
</body></html>"""
