...
用法：
  python -m scripts.tools.debug_overlap                              # 比亚迪，默认参数
  python -m scripts.tools.debug_overlap --code sh600519               # 茅台
  python -m scripts.tools.debug_overlap --days 3 --pct 2.0            # 连续3天重叠>2%
"""
